...
public class Exercise01Impl implements Exercises01 {
     ...
     */
    @Override public Comparator<IncomeStatistics> byIncome() {
     ...
     */
    @Override public Comparator<IncomeStatistics> byYear() {
        return (o1,  o2)-> 0;
    }
     ...
     */
    @Override public List<IncomeStatistics> getStatisticsForYearsBefore(List<IncomeStatistics> stats, int year) {
